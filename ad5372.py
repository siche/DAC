...
# ipFile = "settings.txt"
IP = '192.168.1.9'
num = [1, 0, 3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 13, 12, 15, 14, 17, 16, 19, 18, 21, 20, 23, 22, 25, 24, 27, 26, 29, 28, 31, 30]
channelAddress = [0x08+i for i in num]
class App(QWidget):
    def __init__(self):
        super().__init__()
        self.setupUI()
    ...
    def createShutters(self):
        ...
        # Shutter trigger settings
        buttons = ["935", "Protection", "399"]
        nums = [13, 14, 15]
